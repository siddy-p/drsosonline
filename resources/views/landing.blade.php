...
<head>
  ...
  <title>Dr.SOS — Choose Your Portal</title>
  ...
  <style>
    * {
    ...
    .panel {
      ...
      padding: 40px 48px;
      overflow: hidden;
      transition: flex .55s cubic-bezier(.77, 0, .175, 1);
    }
    ...
    /* ── Edu panel ── */
    .panel-edu {
      background: linear-gradient(145deg, #0d2b1a 0%, #1a4a35 40%, #2d7a55 100%);
    }
    ...
    /* ── Online panel ── */
    .panel-online {
      background: linear-gradient(145deg, #060f1e 0%, #0f2744 40%, #1a4a7a 100%);
    }
    ...
    .panel-online::before {
      ...
      position: absolute;
      inset: 0;
      background: radial-gradient(circle at 30% 70%, rgba(13, 148, 136, .22), transparent 60%);
      pointer-events: none;
    }
    ...
    .panel-edu .portal-badge {
      background: rgba(212, 175, 55, .15);
      border-color: rgba(212, 175, 55, .5);
      color: #f5d96f;
    }

    .panel-online .portal-badge {
    ...
    .panel-edu .panel-icon {
      color: #d4af37;
    }

    .panel-online .panel-icon {
      color: #0d9488;
    }
    ...
    .panel-edu .panel-title .brand-accent {
      color: #d4af37;
    }

    .panel-online .panel-title .brand-accent {
      color: #0d9488;
    }
    ...
    .panel-edu .enter-btn {
      background: linear-gradient(135deg, #d4af37, #f5d96f);
      color: #0d2b1a;
    }

    .panel-online .enter-btn {
    ...
    .cursor-edu {
      background: radial-gradient(circle, #d4af37, #a07a20);
    }

    .cursor-online {
      background: radial-gradient(circle, #0d9488, #065f56);
    }
...
<body>
  <!-- Custom cursor Follows hover portal -->
  @if(session('danger'))
    <div class="flash-toast flash-danger" style="position: absolute; top: 20px; right: 20px; z-index: 999999;">
  ...
  @endif
  @if(session('info'))
    <div class="flash-toast flash-info" style="position: absolute; top: 20px; right: 20px; z-index: 999999;">
  ...
  <div id="customCursor" class="cursor cursor-edu"></div>

  <div class="split">

    <!-- ═══ EDU PANEL ═══ -->
    <div class="panel panel-edu" id="panelEdu">
      <div class="blob blob-edu-1"></div>
      <div class="blob blob-edu-2"></div>
      <a href="{{ route('edu.home') }}" class="panel-link" aria-label="Enter EduConsult portal"></a>
      <div class="panel-content">
        <div class="portal-badge"><i class="fas fa-graduation-cap"></i>Education</div>
        <i class="fas fa-graduation-cap panel-icon"></i>
        <h1 class="panel-title">Dr.SOS<span><span class="brand-accent">EduConsult</span></span></h1>
        <p class="panel-tagline">Study Abroad, Study Smart</p>
    ...
    <!-- ═══ DIVIDER ═══ -->
    <div class="divider">
      <div class="divider-logo">SOS</div>
    </div>

    <!-- ═══ ONLINE PANEL ═══ -->
    <div class="panel panel-online" id="panelOnline">
      <div class="blob blob-on-1"></div>
      <div class="blob blob-on-2"></div>
      <a href="{{ route('online.home') }}" class="panel-link" aria-label="Enter Online Consultation portal"></a>
      <div class="panel-content">
        <div class="portal-badge"><i class="fas fa-stethoscope"></i>Medical</div>
        <i class="fas fa-stethoscope panel-icon"></i>
        <h1 class="panel-title">Dr.SOS<span><span class="brand-accent">Online</span></span></h1>
        <p class="panel-tagline">See a Doctor Today</p>
